...
RSpec.describe UsersController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      let(:user_params) { valid_attributes }
      let(:session_params) { valid_session }
    ...
    context "with invalid params" do
      let(:user_params) { invalid_attributes }
      let(:session_params) { valid_session }
    ...
    context 'when testing mail' do
      let(:user_params) { valid_attributes }
      let(:session_params) { valid_session }

      before { subject }

      it { expect(UserMailer).to receive(:sample_email).with(@user) }
    end
  end
